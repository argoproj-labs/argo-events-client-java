...
public class PubSubEventSource {
  ...
  **/
  @ApiModelProperty(required = true, value = "CredentialsFile is the file that contains credentials to authenticate for GCP Deprecated: will be removed in v1.5, use CredentialSecret instead")
