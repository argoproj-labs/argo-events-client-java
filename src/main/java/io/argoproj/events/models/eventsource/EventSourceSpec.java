...
import io.argoproj.events.models.eventsource.BitbucketEventSource;
...
public class EventSourceSpec {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "Bitbucket event sources")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.gitlab, eventSourceSpec.gitlab) &&
        ...
        Objects.equals(this.bitbucket, eventSourceSpec.bitbucket) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(gitlab, minio, kafka, file, nsq, pulsar, calendar, hdfs, amqp, service, generic, redis, mqtt, template, replicas, sqs, webhook, azureEventsHub, sns, emitter, pubSub, bitbucket, github, resource, slack, eventBusName, nats, storageGrid, bitbucketserver, stripe);
  }
