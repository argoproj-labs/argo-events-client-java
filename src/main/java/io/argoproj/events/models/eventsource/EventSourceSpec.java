...
public class EventSourceSpec {
  ...
  **/
  ...
  @Override
  public int hashCode() {
    return Objects.hash(gitlab, minio, kafka, replica, file, nsq, pulsar, calendar, hdfs, amqp, service, generic, redis, mqtt, template, sqs, webhook, azureEventsHub, sns, emitter, pubSub, github, resource, slack, eventBusName, nats, storageGrid, stripe);
  }
