...
public class EventSourceSpec {
  ...
  **/
  ...
  public EventSourceSpec replica(Integer replica) {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "DeprecatedReplica is the event source deployment replicas Deprecated: use replicas instead, will be removed in v1.5")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.gitlab, eventSourceSpec.gitlab) &&
        ...
        Objects.equals(this.replica, eventSourceSpec.replica) &&
  ...
  @Override
  public int hashCode() {
    return Objects.hash(gitlab, minio, kafka, replica, file, nsq, pulsar, calendar, hdfs, amqp, service, generic, redis, mqtt, template, replicas, sqs, webhook, azureEventsHub, sns, emitter, pubSub, github, resource, slack, eventBusName, nats, storageGrid, stripe);
  }
