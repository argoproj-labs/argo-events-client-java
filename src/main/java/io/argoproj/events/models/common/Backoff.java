...
public class Backoff {
  ...
  public Backoff duration(Long duration) {
   ...
   * @return duration
  **/
  @ApiModelProperty(required = true, value = "Duration is the duration in nanoseconds")
  ...
  **/
   ...
   * @return factor
  **/
  @ApiModelProperty(required = true, value = "Amount represent a numeric amount.")
