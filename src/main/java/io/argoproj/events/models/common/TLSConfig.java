...
public class TLSConfig {
  ...
  public TLSConfig clientKeyPath(String clientKeyPath) {
   ...
   /**
   * DeprecatedClientKeyPath refers the file path that contains client key. Deprecated: will be removed in v1.5, use ClientKeySecret instead
   * @return clientKeyPath
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "DeprecatedClientKeyPath refers the file path that contains client key. Deprecated: will be removed in v1.5, use ClientKeySecret instead")
  ...
  **/
  ...
  public TLSConfig clientCertPath(String clientCertPath) {
   ...
   /**
   * DeprecatedClientCertPath refers the file path that contains client cert. Deprecated: will be removed in v1.5, use ClientCertSecret instead
   * @return clientCertPath
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "DeprecatedClientCertPath refers the file path that contains client cert. Deprecated: will be removed in v1.5, use ClientCertSecret instead")
  ...
  **/
  ...
  public TLSConfig caCertPath(String caCertPath) {
   ...
   /**
   * DeprecatedCACertPath refers the file path that contains the CA cert. Deprecated: will be removed in v1.5, use CACertSecret instead
   * @return caCertPath
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "DeprecatedCACertPath refers the file path that contains the CA cert. Deprecated: will be removed in v1.5, use CACertSecret instead")
