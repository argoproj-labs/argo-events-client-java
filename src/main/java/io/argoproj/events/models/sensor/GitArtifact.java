...
public class GitArtifact {
  ...
  **/
  @javax.annotation.Nullable
  @ApiModelProperty(value = "DeprecatedSSHKeyPath is path to your ssh key path. Use this if you don't want to provide username and password. ssh key path must be mounted in sensor pod. DEPRECATED: use SSHKeySecret instead.")
